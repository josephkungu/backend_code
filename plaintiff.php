...
$sql= "INSERT INTO `data`.`plaintiff`". "
	(plaintiffID,firstName,lastName,caseNo,emailAddress,phoneNo)".
	"VALUES('$plaintiffID','$firstName','$lastName','$caseNo','$emailAddress','$phoneNo')";
...
<table class="pending">
	<tr>
		<td>plaintiff ID:</td>
		<td><input type="text" name="plaintiffID" class="name" placeholder="plaintiff ID"></td>
	</tr>
	<tr>
		<td>First Name:</td>
	...
	<tr>
		<td>Phone No:</td>
		<td><input type="text" name="phoneNo" class="name" placeholder="Phone No"></td>
	</tr>
	<tr>
</table>
<br>
